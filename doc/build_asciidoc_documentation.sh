...
rm -f "${OUTPUT_DIRECTORY}/nerva-tensorflow.html"
...
asciidoctor "${COMMON_OPTS[@]}" -a "bibtex-file=../latex/nerva.bib" nerva-tensorflow.adoc
echo "Generated: ${OUTPUT_DIRECTORY}/nerva-tensorflow.html"
popd >/dev/null
