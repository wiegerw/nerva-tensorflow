...
from nerva_tensorflow.matrix_operations import Diag, column_repeat, exp, hadamard, identity, is_row_vector, log, \
    reciprocal, row_repeat, rows_max, rows_sum, Matrix
